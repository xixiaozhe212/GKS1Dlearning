...
// constant expression
constexpr double u1 = 0.698, rho1 = 0.445, p1 = 3.528;
constexpr double u2 = 0, rho2 = 0.5, p2 = 0.571;
...
{
    return fp(pstar, p1, rho1)+fp(pstar,p2,rho2)-(u1 -u2);
}
...
int main()
{
    ...
    for (int k = 0; k<t.size(); k++)
    {
        ...
        string filename = "lax"+ to_string(t[k]) +".dat";
